...
public class SearchListviewCustomAdapter extends BaseAdapter {
    ...
    public SearchListviewCustomAdapter(Activity context, List<JsonWorkflowList.OptionList> optionList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            rowView = inflater.inflate(R.layout.dynamic_searach_adapter, null);
