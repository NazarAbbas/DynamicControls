...
public class mSngleSearchListView extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dynamic_single_search_listview);
    ...
    private void showUI() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String result = "";
                Gson gson = new Gson();
                result = gson.toJson(optionList.get(position));
                Intent intent = new Intent(getIntent().getStringExtra(SEARCH_EDITTEXT_NAME_KEY));
                intent.putExtra("singlemessage", result);
                LocalBroadcastManager.getInstance(mSngleSearchListView.this).sendBroadcast(intent);
                finish();
            }
        });
