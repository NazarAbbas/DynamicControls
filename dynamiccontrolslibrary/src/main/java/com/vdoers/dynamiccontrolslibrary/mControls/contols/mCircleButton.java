...
public class mCircleButton extends android.support.v7.widget.AppCompatImageView {
    ...
    public mCircleButton(Context context) {
        super(context);
        init(context, null);
    }

    public mCircleButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public mCircleButton(Context context, AttributeSet attrs, int defStyle) {
